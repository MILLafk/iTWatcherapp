                ...
                count_dict = {}  # reset counts every hour
                    ...
                    if current_minute % write_interval == 0:  # write to file once only every write_interval minutes
                        if current_minute not in count_dict:
                            ...
                            new_list =[x for x in names if x != 'blue_tricycle']        
                            restriction_file.write("{}, tricycle color not allowed detected:{}\n".format(str(intersection_time), new_list))
                            
                            restriction_file.close()
