...
class VehiclesCounting():
    ...
    def run(self):
        ...
        while True:
            ...
            pts = np.array([[1010,200],[1650,200],[1830,350],[1008,350]], np.int32)
            isClosed = True
            color_pts = (0,255,0)
            cv2.polylines(frame, [pts], isClosed, color_pts, 2)
            ...
            for track in tracker.tracks:
                ...
                if self._intersect(midpoint, previous_midpoint, pts[2], pts[3]) and track.track_id not in already_counted:
