        ...
        while True:
            ...
            if return_value:
                ...
                if total_frames % skip_frames == 0:
                    ...
                    saved_track_ids = {}
                    '''roi_xmin = 0  # Top-left x-coordinate
                    roi_ymin = int(frame.shape[0]/2)   # Top-left y-coordinate
                    roi_xmax = int(frame.shape[1])  # Bottom-right x-coordinate
                    roi_ymax = int(frame.shape[0])  # Bottom-right y-coordinate
                    roi = (roi_xmin, roi_ymin, roi_xmax, roi_ymax)
                    cv2.rectangle(frame, (roi_xmin, roi_ymin), (roi_xmax, roi_ymax), (0, 255, 0), 2)  # Green rectangle  ''' 
