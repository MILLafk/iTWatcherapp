...
from tracking.deepsort_tric.object_tracker_catchall import VehiclesCounting
import datetime
import requests
...
def process_all(video_path=None, livestream_url=None, is_live_stream=False, video_stream=None):
    ...
    if video_path:
        ...
        vc = VehiclesCounting(file_counter_log_name='vehicle_count.log',
                              framework='tf',
                              weights='/home/ubuntu/iTWatcherapp/tracking/deepsort_tric/checkpoints/catch_all',
                              size=416,
                              tiny=False,
                              model='yolov4',
                              video=video_file,
