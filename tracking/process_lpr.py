...
from tracking.deepsort_tric.object_tracker_ocr import VehiclesCounting
import datetime
import requests
...
def process_frontside(video_path=None, livestream_url=None, is_live_stream=False, video_stream=None):
    ...
    if video_path:
        ...
        vc = VehiclesCounting(file_counter_log_name='vehicle_count.log',
                              framework='tf',
                              weight1='/home/itwatcher/API/tricycle_copy/tracking/deepsort_tric/checkpoints/lpr_all',
                              weight2='/home/itwatcher/API/tricycle_copy/tracking/deepsort_tric/checkpoints/lpr_side',
                              size=416,
                              tiny=False,
                              model='yolov4',
                              video=video_file,
